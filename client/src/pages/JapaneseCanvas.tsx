...
const sections = [
  ...
  {
    title: "Lesson Policy / ご受講にあたって",
    body: "このガイドラインは、すべての受講生が安心して、気持ちよく学べる環境をつくるためのものです。レッスンは Google Meet で行い、個別サポートや教材は専用の学生用学習プラットフォームで共有します。体験レッスンは Cal.com から予約し、継続レッスンは Wise または PayPal にて事前にお支払いいただきます。キャンセルや日程変更は、レッスン開始24時間前まで無料で可能です。予期せぬことが起こることもあるため、緊急時や急な事情がある場合は、できるだけ早めにAyumiへご連絡ください。レッスン開始6時間前を過ぎての日程変更は、状況によっては実施済み扱いになる場合があります。20分以上ご連絡なく遅れた場合も、レッスン完了扱いになる可能性があります。遅れそうな場合は、短いメッセージだけでも送っていただけると助かります。一部のレッスンは、学習の振り返りや成長確認のために録画する場合があります。宿題は任意で、目標や希望に合わせてご提案します。アクティブな受講生は、レッスンノート、単語レビュー、メッセージ、予約アクセス、個別学習サポートを含む学習プラットフォームを利用できます。4回プランは通常2〜3か月、3か月トラベルプランは3か月、6か月ジャーニープランは6か月を有効期間の目安としています。",
  },
  {
    title: "Contact / お問い合わせ",
    body: "レッスン内容や日本旅行の準備について気になることがあれば、いつでも気軽にお問い合わせください。完全初心者の方、初めての日本旅行を計画している方、自分に合うレッスンがわからない方も歓迎です。連絡先メールは beyondjp.lesson@gmail.com です。Instagram は https://www.instagram.com/beyond_japanese.ayumi/ から確認できます。",
  },
];
